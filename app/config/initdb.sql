...
-- Feeds
INSERT INTO feed (feed_id, created_at, updated_at, created_by, updated_by, account, status_id, direction, name, service, remote_root_dir, local_root_dir, filename) VALUES (default, LOCALTIMESTAMP(0), LOCALTIMESTAMP(0), 'initdb', 'initdb', 'GROWERS', 1, 'inbound', 'item', 'orderware.feeds.item_feed_processor', '/var/apps/data/remote/catalog', '/var/apps/data/local/catalog', '/growers_item_(.*).xml/');
